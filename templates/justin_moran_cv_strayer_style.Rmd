---
title: "Justin Bonagura Moran CV"
author: Justin Bonagura Moran
date: "`r Sys.Date()`"
params:
  pdf_mode:
    value: true
...
Conference Activity {data-icon=chalkboard-user}
--------------------------------------------------------------------------------
::: aside
```{r}
...
```{r}
CV <- CV |> print_section('conference')
```
